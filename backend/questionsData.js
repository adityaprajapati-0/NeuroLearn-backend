...
const baseQuestions = [
  { topic: "Arrays", topicFull: "Arrays / Hashing", title: "Two Sum", difficulty: "Easy" },
  { topic: "Arrays", topicFull: "Arrays / DP", title: "Maximum Subarray", difficulty: "Medium" },
  { topic: "Arrays", topicFull: "Arrays / Greedy", title: "Best Time to Buy and Sell Stock", difficulty: "Easy" },
  { topic: "Arrays", topicFull: "Arrays / Prefix Product", title: "Product of Array Except Self", difficulty: "Medium" },
  { topic: "Arrays", topicFull: "Arrays / Rotation", title: "Rotate Array", difficulty: "Easy" },

  { topic: "Arrays", topicFull: "Intervals", title: "Merge Intervals", difficulty: "Medium" },
  { topic: "Arrays", topicFull: "Matrix", title: "Set Matrix Zeroes", difficulty: "Medium" },
  { topic: "Arrays", topicFull: "Binary Search", title: "Search in Rotated Sorted Array", difficulty: "Medium" },
  { topic: "Arrays", topicFull: "Voting Algorithm", title: "Majority Element", difficulty: "Easy" },
  { topic: "Arrays", topicFull: "Matrix", title: "Spiral Matrix", difficulty: "Medium" },

  { topic: "Strings", topicFull: "Two Pointers", title: "Valid Palindrome", difficulty: "Easy" },
  { topic: "Strings", topicFull: "DP", title: "Longest Palindromic Substring", difficulty: "Medium" },
  { topic: "Strings", topicFull: "Sliding Window", title: "Longest Substring Without Repeating", difficulty: "Medium" },
  { topic: "Strings", topicFull: "Hashing", title: "Valid Anagram", difficulty: "Easy" },
  { topic: "Strings", topicFull: "Hashing", title: "Group Anagrams", difficulty: "Medium" },

  { topic: "Linked List", topicFull: "Pointers", title: "Reverse Linked List", difficulty: "Easy" },
  { topic: "Linked List", topicFull: "Cycle Detection", title: "Linked List Cycle", difficulty: "Medium" },
  { topic: "Trees", topicFull: "BFS", title: "Binary Tree Level Order Traversal", difficulty: "Easy" },
  { topic: "Trees", topicFull: "DFS", title: "Diameter of Binary Tree", difficulty: "Medium" },
  { topic: "Graphs", topicFull: "DFS / BFS", title: "Number of Islands", difficulty: "Medium" },
];
...
Object.assign(questionFormats, {
  ...
  33: {
    title: "Path Sum",
    description:
      "Check if the tree has a root-to-leaf path with given sum.",
    constraints: ["0 <= number of nodes <= 10^4"],
    examples: [
      {
        input: {
  ...
  34: {
    ...
    description:
      "Return the number of islands in a 2D grid.",
  ...
  35: {
    ...
    examples: [
      { input: { grid: [[0,0,1,0],[1,1,1,0],[0,0,1,0]] }, output: 5 },
    ],
    testcases: [
      { input: { grid: [[0,0],[0,0]] }, output: 0 },
    ],
  ...
  39: {
    ...
    description:
      "Return an order of courses to finish all courses.",
    constraints: ["1 <= numCourses <= 2000"],
    examples: [
...
Object.assign(questionFormats, {
  ...
  41: {
    ...
    examples: [
      { input: { nums: [1,1,2,2,3,4], target: 5 }, output: [[1,4],[2,3]] },
    ],
    testcases: [
      { input: { nums: [2,2,3,3], target: 5 }, output: [[2,3]] },
    ],
  },
  ...
  43: {
    ...
    description:
      "After selling stock, you cannot buy on the next day.",
    constraints: ["1 <= prices.length <= 10^5"],
    examples: [
  ...
  44: {
    ...
    description:
      "Return product except self under modulo.",
    ...
    testcases: [
      { input: { nums: [2,3], MOD: 1000000007 }, output: [3,2] },
    ],
  },
  ...
  45: {
    ...
    description:
      "Rotate array using in-place reverse method.",
    constraints: ["1 <= nums.length <= 10^5"],
    examples: [
  ...
  46: {
    ...
    description:
      "Return intersections of two interval lists.",
  ...
  47: {
    ...
    description:
      "Set entire row and column zero if border cell is zero.",
    constraints: ["1 <= m,n <= 200"],
    examples: [
      {
  ...
  49: {
    ...
    description:
      "Check whether x appears more than n/2 times.",
    constraints: ["1 <= nums.length <= 10^5"],
    examples: [
      { input: { nums: [1,1,2,1,3], x: 1 }, output: true },
    ],
    testcases: [
      { input: { nums: [1,2,3], x: 2 }, output: false },
    ],
  },
  ...
  51: {
    ...
    description:
      "Check palindrome considering only letters.",
    constraints: ["1 <= s.length <= 2*10^5"],
    examples: [
      { input: { s: "nurses run!" }, output: true },
    ],
    testcases: [
  ...
  55: {
    ...
    description:
      "Return number of distinct anagram groups.",
  ...
  56: {
    ...
    testcases: [
      { input: { head: [1], left: 1, right: 1 }, output: [1] },
    ],
  },
  ...
  57: {
    ...
    description:
      "Return length of cycle if exists.",
    constraints: ["0 <= list length <= 10^4"],
    examples: [
      { input: { head: [1,2,3,4,5], pos: 2 }, output: 3 },
    ],
    testcases: [
      { input: { head: [1,2], pos: -1 }, output: 0 },
    ],
  },
  ...
  59: {
    ...
    description:
      "Return max number of nodes on any path.",
    constraints: ["0 <= nodes <= 10^4"],
    examples: [
  ...
  60: {
    ...
    examples: [
      { input: { grid: [[1,1,1],[1,0,0],[1,0,0]] }, output: 1 },
    ],
    testcases: [
...
Object.assign(questionFormats, {
  ...
  63: {
    ...
    testcases: [
      { input: { prices: [1,1,1], fee: 1 }, output: 0 },
    ],
  },
  ...
  64: {
    ...
    description:
      "Return the product of each contiguous subarray of size k.",
    constraints: ["1 <= k <= nums.length <= 10^5"],
    examples: [
      { input: { nums: [1,2,3,4], k: 2 }, output: [2,6,12] },
    ],
    testcases: [
      { input: { nums: [1,1,1], k: 2 }, output: [1,1] },
    ],
  },
  ...
  67: {
    ...
    description:
      "If a cell is 1, set its entire row and column to 1.",
    constraints: ["1 <= m,n <= 200"],
    examples: [
      {
  ...
  68: {
    ...
    description:
      "Return starting and ending index of target in rotated array.",
    constraints: ["1 <= nums.length <= 10^5"],
    examples: [
      {
  ...
  69: {
    ...
    description:
      "Find majority element using a hash map.",
    constraints: ["1 <= nums.length <= 10^5"],
    examples: [
      { input: { nums: [2,2,1,1,1,2,2] }, output: 2 },
    ],
  ...
  70: {
    ...
    description:
      "Return the k-th element in spiral order.",
    constraints: ["1 <= m,n <= 200"],
    examples: [
      {
  ...
  73: {
    ...
    description:
      "Return longest substring after at most k replacements.",
    constraints: ["1 <= s.length <= 10^5"],
    examples: [
  ...
  74: {
    ...
    description:
      "Determine for each string pair whether they are anagrams.",
    constraints: ["1 <= pairs.length <= 10^4"],
    examples: [
      {
        input: { pairs: [["ab","ba"],["foo","oof"],["bar","baz"]] },
        output: [true,true,false],
      },
    ],
    testcases: [
      { input: { pairs: [["a","a"],["a","b"]] }, output: [true,false] },
    ],
  },
  ...
  75: {
    ...
    description:
      "Return size of largest anagram group.",
    constraints: ["1 <= strs.length <= 10^4"],
    examples: [
      { input: { strs: ["ab","ba","abc","cab","bca","xyz"] }, output: 3 },
    ],
  ...
  77: {
    ...
    description:
      "If cycle exists, remove it and return the list.",
    constraints: ["0 <= list length <= 10^4"],
    examples: [
      { input: { head: [1,2,3,4], pos: 1 }, output: [1,2,3,4] },
    ],
    testcases: [
  ...
  79: {
    ...
    description:
      "Compute diameter using single DFS.",
    constraints: ["0 <= nodes <= 10^4"],
    examples: [
  ...
  80: {
    ...
    description:
      "Return number of land cells that cannot walk off boundary.",
    constraints: ["1 <= m,n <= 500"],
    examples: [
      { input: { grid: [[0,0,0],[1,0,1],[0,1,1]] }, output: 3 },
    ],
    testcases: [
      { input: { grid: [[0,0],[0,0]] }, output: 0 },
    ],
...
Object.assign(questionFormats, {
  ...
  82: {
    ...
    constraints: ["1 <= k <= nums.length <= 10^5"],
    examples: [
      { input: { nums: [1,2,3,-10,5,6], k: 2 }, output: 11 },
    ],
    testcases: [
  ...
  86: {
    ...
    examples: [
      { input: { intervals: [[1,3],[2,6],[8,10]] }, output: 7 },
    ],
    testcases: [
  ...
  88: {
    ...
    description:
      "Return number of occurrences of target in rotated array.",
    constraints: ["1 <= nums.length <= 10^5"],
    examples: [
      {
    ...
    testcases: [
      { input: { nums: [1,1,1], target: 1 }, output: 3 },
    ],
  },
  ...
  89: {
    ...
    description:
      "Return majority element if exists, else return -1.",
    constraints: ["1 <= nums.length <= 10^5"],
    examples: [
  ...
  90: {
    ...
    description:
      "Return spiral traversal starting from center cell.",
  ...
  91: {
    ...
    description:
      "Check if numeric characters form a palindrome.",
    constraints: ["1 <= s.length <= 2 * 10^5"],
    examples: [
      { input: { s: "a1b2c2b1d" }, output: true },
    ],
    testcases: [
      { input: { s: "abc123" }, output: false },
    ],
  },
  ...
  93: {
    ...
    description:
      "Return count of substrings without repeated characters.",
    constraints: ["0 <= s.length <= 2 * 10^5"],
    examples: [
      { input: { s: "abca" }, output: 8 },
    ],
    testcases: [
  ...
  94: {
    ...
    description:
      "Check anagram considering unicode characters.",
    constraints: ["1 <= s.length <= 10^5"],
    examples: [
      { input: { s: "àçb", t: "çàb" }, output: true },
    ],
    testcases: [
      { input: { s: "ä", t: "a" }, output: false },
    ],
  },
  ...
  95: {
    ...
    description:
      "Group anagrams using character frequency instead of sorting.",
    constraints: ["1 <= strs.length <= 10^4"],
    examples: [
      { input: { strs: ["eat","tea","ate","bat"] }, output: [["eat","tea","ate"],["bat"]] },
    ],
    testcases: [
      { input: { strs: ["a","b"] }, output: [["a"],["b"]] },
    ],
  },
  ...
  99: {
    ...
    description:
      "Return diameter of a skewed tree.",
    constraints: ["0 <= nodes <= 10^4"],
    examples: [
      { input: { root: [1,2,null,3,null,4] }, output: 3 },
    ],
    testcases: [
      { input: { root: [1] }, output: 0 },
    ],
  ...
  100: {
    ...
    examples: [
      {
        input: { grid: [[1,1,0,1],[1,0,0,0],[0,0,1,1],[0,0,1,1]] },
        output: 2,
      },
    ],
    testcases: [
